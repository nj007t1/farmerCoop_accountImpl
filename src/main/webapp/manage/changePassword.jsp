...
<body>
	...
	<form action="../changePassword.do" method="post">
		...
		新密碼:<input name='newPassword' Type='password' size='20'
			value="${param.newPassword}"><br>
		<div style="color: red; font-size: 60%">${ErrorMsg.newPassword}</div>
		新密碼確認:<input name='checkPassword' Type='password' size='20'
			value="${param.checkPassword}"><br>
